...
export default function SubsidyCard({
  ...
  return (
    <Card className="h-[180px] overflow-hidden rounded-2xl border border-emerald-200 bg-zinc-50 transition-shadow duration-200 hover:shadow-lg hover:shadow-black/20 dark:border-[hsl(82,50%,32%)]/30 dark:bg-[#323b22]">
      ...
      <CardContent className="space-y-2 p-4 pt-2">
        ...
        <Progress value={pct} className="h-1.5 rounded-full bg-zinc-200 dark:bg-[hsl(84,8%,30%)] [&>div]:rounded-full [&>div]:bg-emerald-500 [&>div]:dark:bg-[hsl(82,50%,32%)]" />
        {is_small && (
        ...
        <div className="flex gap-3 rounded-lg border border-zinc-200 bg-zinc-100/50 px-2 py-1.5 text-[11px] dark:border-[hsl(84,8%,30%)] dark:bg-[#2e3420]">
          <CardDescription className="text-zinc-500 dark:text-[hsl(84,8%,68%)]">
