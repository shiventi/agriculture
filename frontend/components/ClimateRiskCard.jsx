...
function getRiskLevel(score) {
  if (score < 0.4) return { label: 'Low', variant: 'outline', className: 'border-emerald-200 bg-emerald-50 text-emerald-700 dark:bg-[hsl(82,50%,32%)]/20 dark:text-[hsl(82,50%,60%)]' }
  ...
  return { label: 'High risk', variant: 'default', className: 'border-0 bg-red-50 text-red-700 dark:bg-red-950/50 dark:text-red-400' }
}
