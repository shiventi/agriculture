...
export default function ReasoningCard({ farm_id, reasoning }) {
  return (
    <Card className="reasoning-card h-[160px] overflow-hidden rounded-2xl border-l-4 border-l-amber-500 border-border bg-card transition-shadow hover:shadow-lg hover:shadow-black/20">
